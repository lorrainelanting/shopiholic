    ...
    <div class="row">
      ...
      <div class="col-2">
        <div id="myAccount" class="">
          <a href="/user/profile" class="font-weight-bold text-decoration-none"
            >My Account</a
          >
          <div>
            <a href="/user/profile" class="text-muted text-decoration-none ml-4"
              >Profile</a
            >
          </div>
          <div>
            <a href="/user/address" class="text-muted text-decoration-none ml-4"
              >Address Book</a
            >
          </div>
          <div>
            <a
              href="/user/password"
              class="text-muted text-decoration-none ml-4"
              >Change Password</a
            >
          </div>
        </div>
        <div id="myOrders" class="">
          <a href="/user/orders" class="font-weight-bold text-decoration-none"
            >My Orders</a
          >
        </div>
      </div>
      ...
      <form class="col-10">
        <div class="card border-0 shadow-sm">
          <div class="card-body">
            <h5 class="card-title font-weight-bold border-bottom">
              Profile Information
            </h5>
            <div class="row">
            ...
            <form>
              <div class="form-group row">
                <label
                  for="fullName"
                  class="col-sm-2 col-form-label text-muted text-right"
                  >Full Name</label
                >
                <div class="col-sm-8">
...
export default {
  ...
  computed: {
    userProfile() {
      ...
      return this.$route.params.userprofile;
    },
  },
